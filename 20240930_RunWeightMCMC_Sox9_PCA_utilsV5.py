...
def run_mcmc(save_dir):
    ...
    pc1_grid = np.linspace(pc1_l, pc1_u, num_metastructure)
    pc2_grid = np.linspace(pc2_l, pc2_u, num_metastructure)
    ...
    # lpm = [0 for x in templates_flatten]
...
if __name__ == '__main__':
    save_dir = '/mnt/home/tudomlumleart/ceph/01_ChromatinEnsembleRefinement/chromatin-ensemble-refinement/MCMC_results/20240912_RunWeightMCMC_Sox9_PCA_utilsV4/'
