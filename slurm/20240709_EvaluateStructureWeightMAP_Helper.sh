...
SLURM_JOB_SCRIPT_TEMPLATE="/mnt/home/tudomlumleart/ceph/01_ChromatinEnsembleRefinement/chromatin-ensemble-refinement/scripts/slurm/20240708_EvaluateStructureWeightMAP.sh"
...
do
    ...
    if [ -f "$PROCESSED_DIRECTORY/$RESULTS_FILE" ]; then
        ...
        # Submit the job using the SLURM job script template, passing the file as an argument
