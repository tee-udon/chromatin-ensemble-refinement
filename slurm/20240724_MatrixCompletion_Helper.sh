...
SLURM_JOB_SCRIPT_TEMPLATE=/mnt/home/tudomlumleart/ceph/01_ChromatinEnsembleRefinement/chromatin-ensemble-refinement/scripts/slurm/20240724_MatrixCompletion.sh
