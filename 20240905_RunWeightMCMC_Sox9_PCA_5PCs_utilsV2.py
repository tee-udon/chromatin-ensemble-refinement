4# This version of MCMC is compatible with the revised version of 
...
def run_mcmc(save_dir):
    ...
    pc_df = pc_df.sort_values(by=['PC1', 'PC2', 'PC3', 'PC4', 'PC5'], ascending=[True, False, False, False, False], ignore_index=True)  
...
if __name__ == '__main__':
    save_dir = '/mnt/home/tudomlumleart/ceph/01_ChromatinEnsembleRefinement/chromatin-ensemble-refinement/MCMC_results/20240905_RunWeightMCMC_Sox9_PCA_5PCs_utilsV2.py/'
