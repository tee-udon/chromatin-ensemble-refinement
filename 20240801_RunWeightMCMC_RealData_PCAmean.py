...
def run_mcmc(save_dir):
    ...
    measurement_error_esc = [calculate_variance_sample(esc_maps_interp, x.reshape(80, 80))**0.5 for x in templates_flatten]
    measurement_error_cnc = [calculate_variance_sample(cnc_maps_interp, x.reshape(80, 80))**0.5 for x in templates_flatten]
    measurement_error_all = [calculate_variance_sample(all_maps_interp, x.reshape(80, 80))**0.5 for x in templates_flatten]
...
if __name__ == '__main__':
    save_dir = '/mnt/home/tudomlumleart/ceph/01_ChromatinEnsembleRefinement/chromatin-ensemble-refinement/MCMC_results/20240801_WeightMCMC_PCA_metastructures/'
