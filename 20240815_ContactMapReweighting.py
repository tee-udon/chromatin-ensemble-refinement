...
if __name__ == '__main__':
    save_dir = '/mnt/home/tudomlumleart/ceph/01_ChromatinEnsembleRefinement/chromatin-ensemble-refinement/MCMC_results/20240815_WeightMCMC_ContactMap/'
            
    print(f"Running MCMC ...")
    for num_metastructures in [10, 20, 30, 40, 50]:
        new_dir = os.path.join(save_dir, str(num_metastructures))
